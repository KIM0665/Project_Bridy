...
키-값 구조를 사용하여 데이터를 추출하는 작업이 처음이었지만, 가독성이 좋았습니다. 메인 페이지에 추가 데이터를 표시하기 위해 추가 데이터 가공 작업도 수행했습니다.
<br>
이 프로젝트를 통해 요구사항 명세서와 기능 설계, 그리고 팀원 간의 소통과 협업의 중요성을 배웠습니다. 초기 설계와 명세서 작성이 어려웠지만, <br>
지속적인 의사소통을 통해 문제를 해결하고 중복성을 최소화하는 방법을 고민하게 되었습니다.
<br>
